    ...
    <section className="py-32 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Our Practice Areas</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="bg-gray-200 h-48 w-full rounded-md flex items-center justify-center mb-4">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Hot Coffee Incidents</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Misleading Advertising</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Emotional Distress</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Shopping Injuries</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Birthday Disappointments</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Confusing Instructions</h3>
            <p className="text-gray-700">
